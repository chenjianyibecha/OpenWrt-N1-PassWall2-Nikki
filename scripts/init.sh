...
d '
    ...
    . set_env "passwall_luci_repo" "https://github.com/OpenWrt-Passwall/openwrt-passwall"
    . set_env "passwall_pkg_repo" "https://github.com/OpenWrt-Passwall/openwrt-passwall-packages"
    . set_env "passwall2_repo" "https://github.com/OpenWrt-Passwall/openwrt-passwall2"
